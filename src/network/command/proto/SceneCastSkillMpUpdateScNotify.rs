...
impl ::protobuf::Message for SceneCastSkillMpUpdateScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.mp != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.mp);
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Notify\x12$\n\x0ecast_entity_id\x18\x08\x20\x01(\rR\x0ccastEntityId\x12\
    \x0e\n\x02mp\x18\x0f\x20\x01(\rR\x02mpb\x06proto3\
";
