...
//! Generated file from `EFDHFOEMKHH.proto`
...
// @@protoc_insertion_point(enum:EFDHFOEMKHH)
...
impl ::protobuf::Enum for EFDHFOEMKHH {
    const NAME: &'static str = "EFDHFOEMKHH";
...
impl ::protobuf::EnumFull for EFDHFOEMKHH {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("EFDHFOEMKHH").unwrap()).clone()
    }
...
impl ::std::default::Default for EFDHFOEMKHH {
    fn default() -> Self {
        EFDHFOEMKHH::EFDHFOEMKHH_NLCDGIPGFDJ
    }
}
...
impl EFDHFOEMKHH {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<EFDHFOEMKHH>("EFDHFOEMKHH")
    }
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(EFDHFOEMKHH::generated_enum_descriptor_data());
