...
impl ::protobuf::Message for SceneMonsterWave {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.battle_wave_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.battle_wave_id);
        }
        ...
        if self.battle_stage_id != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.battle_stage_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.battle_wave_id != 0 {
            os.write_uint32(1, self.battle_wave_id)?;
        }
        for v in &self.monster_list {
            ::protobuf::rt::write_message_field_with_cached_size(5, v, os)?;
        };
        if self.battle_stage_id != 0 {
            os.write_uint32(10, self.battle_stage_id)?;
        }
        if let Some(v) = self.monster_param.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12$\n\x0ebattle_wave_id\x18\x01\x20\x01(\rR\x0cbattleWaveId\x120\n\x0c\
    monster_list\x18\x05\x20\x03(\x0b2\r.SceneMonsterR\x0bmonsterList\x12&\n\
    \x0fbattle_stage_id\x18\n\x20\x01(\rR\rbattleStageId\x12;\n\rmonster_par\
    am\x18\x0c\x20\x01(\x0b2\x16.SceneMonsterWaveParamR\x0cmonsterParam\x12+\
    \n\x0bNMGIABHIJJB\x18\x0e\x20\x03(\x0b2\t.ItemListR\x0bNMGIABHIJJBb\x06p\
    roto3\
";
