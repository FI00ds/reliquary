...
impl ::protobuf::Message for DoGachaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GLLJFPENLHD != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.GLLJFPENLHD);
        }
        ...
        if self.LDBCKJIPDHF != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.LDBCKJIPDHF);
        }
        if self.NHBBHEMPJJM != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.NHBBHEMPJJM);
        }
        if self.gacha_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.gacha_id);
        }
        if self.GPNLDDLBOLM != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.GPNLDDLBOLM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.GLLJFPENLHD != 0 {
            os.write_uint32(1, self.GLLJFPENLHD)?;
        }
        if self.ceiling_num != 0 {
        ...
        if self.LDBCKJIPDHF != 0 {
            os.write_uint32(12, self.LDBCKJIPDHF)?;
        }
        if self.NHBBHEMPJJM != 0 {
            os.write_uint32(13, self.NHBBHEMPJJM)?;
        }
        if self.gacha_id != 0 {
            os.write_uint32(14, self.gacha_id)?;
        }
        if self.GPNLDDLBOLM != 0 {
            os.write_uint32(15, self.GPNLDDLBOLM)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Rsp\x12\x20\n\x0bGLLJFPENLHD\x18\x01\x20\x01(\rR\x0bGLLJFPENLHD\x12\x1f\
    \n\x0bceiling_num\x18\x04\x20\x01(\rR\nceilingNum\x12\x1b\n\tgacha_num\
    \x18\x08\x20\x01(\rR\x08gachaNum\x122\n\x0fgacha_item_list\x18\t\x20\x03\
    (\x0b2\n.GachaItemR\rgachaItemList\x12\x18\n\x07retcode\x18\x0b\x20\x01(\
    \rR\x07retcode\x12\x20\n\x0bLDBCKJIPDHF\x18\x0c\x20\x01(\rR\x0bLDBCKJIPD\
    HF\x12\x20\n\x0bNHBBHEMPJJM\x18\r\x20\x01(\rR\x0bNHBBHEMPJJM\x12\x19\n\
    \x08gacha_id\x18\x0e\x20\x01(\rR\x07gachaId\x12\x20\n\x0bGPNLDDLBOLM\x18\
    \x0f\x20\x01(\rR\x0bGPNLDDLBOLMb\x06proto3\
";
