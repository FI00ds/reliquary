...
impl ::protobuf::Message for SyncRogueCommonPendingActionScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.DLOJFEEHLIJ != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.DLOJFEEHLIJ);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DLOJFEEHLIJ != 0 {
            os.write_uint32(5, self.DLOJFEEHLIJ)?;
        }
        if let Some(v) = self.action.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05\x20\x01(\rR\x0bDLOJFEEHLIJ\x12$\n\x06action\x18\x07\x20\x01(\x0b2\
    \x0c.INHBMHCJJCNR\x06actionb\x06proto3\
";
