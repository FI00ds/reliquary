...
impl ::protobuf::Message for QueryProductInfoScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.BEBFNDIGKFK != 0 {
            os.write_uint32(5, self.BEBFNDIGKFK)?;
        }
        if self.month_card_out_date_time != 0 {
            os.write_uint64(9, self.month_card_out_date_time)?;
        }
        if self.BFFHEKCGLMA != 0 {
            os.write_uint32(10, self.BFFHEKCGLMA)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    yProductInfoScRsp\x12\x20\n\x0bBEBFNDIGKFK\x18\x05\x20\x01(\rR\x0bBEBFND\
    IGKFK\x126\n\x18month_card_out_date_time\x18\t\x20\x01(\x04R\x14monthCar\
    dOutDateTime\x12\x20\n\x0bBFFHEKCGLMA\x18\n\x20\x01(\rR\x0bBFFHEKCGLMA\
    \x12+\n\x0cproduct_list\x18\x0b\x20\x03(\x0b2\x08.ProductR\x0bproductLis\
