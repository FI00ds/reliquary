...
impl ::protobuf::Message for JOGCCINEHFJ {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FNIAOAOBKBA != false {
            os.write_bool(2, self.FNIAOAOBKBA)?;
        }
        if self.unique_id != 0 {
        ...
        if self.DIHFBELJFIA != false {
            os.write_bool(12, self.DIHFBELJFIA)?;
        }
        if self.affix_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    KBA\x18\x02\x20\x01(\x08R\x0bFNIAOAOBKBA\x12\x1b\n\tunique_id\x18\x07\
    \x20\x01(\rR\x08uniqueId\x12!\n\x0cmonster_list\x18\n\x20\x03(\rR\x0bmon\
    sterList\x12\x20\n\x0bDIHFBELJFIA\x18\x0c\x20\x01(\x08R\x0bDIHFBELJFIA\
    \x12\x19\n\x08affix_id\x18\x0e\x20\x01(\rR\x07affixIdb\x06proto3\
";
