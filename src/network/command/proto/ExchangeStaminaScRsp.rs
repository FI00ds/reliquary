...
impl ::protobuf::Message for ExchangeStaminaScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.last_recover_time != 0 {
            my_size += ::protobuf::rt::int64_size(11, self.last_recover_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.last_recover_time != 0 {
            os.write_int64(11, self.last_recover_time)?;
        }
        if self.stamina_add != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12/\n\x0eitem_cost_list\x18\n\x20\x03(\x0b2\t.ItemCostR\x0citemCostLis\
    t\x12*\n\x11last_recover_time\x18\x0b\x20\x01(\x03R\x0flastRecoverTime\
    \x12\x1f\n\x0bstamina_add\x18\x0c\x20\x01(\rR\nstaminaAdd\x12%\n\x0eexch\
    ange_times\x18\r\x20\x01(\rR\rexchangeTimesb\x06proto3\
";
