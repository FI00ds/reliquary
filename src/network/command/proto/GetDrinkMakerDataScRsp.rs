...
impl ::protobuf::Message for GetDrinkMakerDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.FHPKJONKHAC != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.FHPKJONKHAC);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.retcode);
        }
        if self.FGBELHJAKCC != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.FGBELHJAKCC);
        }
        if self.exp != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.exp);
        }
        if self.GNIFLCBGAAA != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.GNIFLCBGAAA);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.FHPKJONKHAC != 0 {
            os.write_uint32(4, self.FHPKJONKHAC)?;
        }
        if self.retcode != 0 {
            os.write_uint32(5, self.retcode)?;
        }
        if self.FGBELHJAKCC != 0 {
            os.write_uint32(8, self.FGBELHJAKCC)?;
        }
        if self.exp != 0 {
            os.write_uint32(9, self.exp)?;
        }
        if self.GNIFLCBGAAA != 0 {
            os.write_uint32(11, self.GNIFLCBGAAA)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    AFL\x18\x01\x20\x03(\rR\x0bCJKAGEDKAFL\x12\x20\n\x0bEMIAIOMOLPO\x18\x02\
    \x20\x01(\rR\x0bEMIAIOMOLPO\x12\x20\n\x0bFHPKJONKHAC\x18\x04\x20\x01(\rR\
    \x0bFHPKJONKHAC\x12\x18\n\x07retcode\x18\x05\x20\x01(\rR\x07retcode\x12\
    \x20\n\x0bFGBELHJAKCC\x18\x08\x20\x01(\rR\x0bFGBELHJAKCC\x12\x10\n\x03ex\
    p\x18\t\x20\x01(\rR\x03exp\x12\x20\n\x0bGNIFLCBGAAA\x18\x0b\x20\x01(\rR\
    \x0bGNIFLCBGAAA\x12.\n\x0bONFNEDNFOLL\x18\r\x20\x03(\x0b2\x0c.KKIACMJGIK\
    NR\x0bONFNEDNFOLL\x12\x14\n\x05level\x18\x0e\x20\x01(\rR\x05level\x12.\n\
    \x0bLMOGDPMLKFH\x18\x0f\x20\x01(\x0b2\x0c.DFJPGILAAONR\x0bLMOGDPMLKFHb\
    \x06proto3\
";
