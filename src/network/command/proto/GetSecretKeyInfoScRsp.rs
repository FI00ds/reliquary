...
impl ::protobuf::Message for GetSecretKeyInfoScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.secret_rsp.is_empty() {
            my_size += ::protobuf::rt::bytes_size(4, &self.secret_rsp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.secret_rsp.is_empty() {
            os.write_bytes(4, &self.secret_rsp)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tcode\x12\x1d\n\nsecret_rsp\x18\x04\x20\x01(\x0cR\tsecretRsp\x12/\n\x0bs\
    ecret_info\x18\x0f\x20\x03(\x0b2\x0e.SecretKeyInfoR\nsecretInfob\x06prot\
    o3\
";
