...
impl ::protobuf::Message for GetTrainVisitorRegisterScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.BLKHPCPALDN);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(7, &self.BLKHPCPALDN)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x1cGetTrainVisitorRegisterScRsp\x12.\n\x0bNEDBIFJPBDJ\x18\x03\x20\
    \x03(\x0b2\x0c.MNKGDKAIELHR\x0bNEDBIFJPBDJ\x12\x20\n\x0bBLKHPCPALDN\x18\
    \x07\x20\x03(\rR\x0bBLKHPCPALDN\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\
