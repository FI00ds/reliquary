...
impl ::protobuf::Message for AcceptMultipleExpeditionScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BJMGDBCHEAN != 0 {
            my_size += ::protobuf::rt::int64_size(14, self.BJMGDBCHEAN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.BJMGDBCHEAN != 0 {
            os.write_int64(14, self.BJMGDBCHEAN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17accept_multi_expedition\x18\x02\x20\x03(\x0b2\x0f.ExpeditionInfoR\
    \x15acceptMultiExpedition\x12\x18\n\x07retcode\x18\x08\x20\x01(\rR\x07re\
    tcode\x12+\n\x0bDJOBNPIAEJP\x18\r\x20\x03(\x0b2\t.ItemListR\x0bDJOBNPIAE\
    JP\x12\x20\n\x0bBJMGDBCHEAN\x18\x0e\x20\x01(\x03R\x0bBJMGDBCHEANb\x06pro\
    to3\
";
