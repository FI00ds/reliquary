...
impl ::protobuf::Message for TrainPartyArea {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.verify_step_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.step_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.static_prop_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.verify_step_id_list)?;
        os.write_repeated_packed_uint32(2, &self.step_id_list)?;
        os.write_repeated_packed_uint32(8, &self.static_prop_id_list)?;
        if let Some(v) = self.area_step_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x03(\rR\x10verifyStepIdList\x12\x20\n\x0cstep_id_list\x18\
    \x02\x20\x03(\rR\nstepIdList\x12-\n\x13static_prop_id_list\x18\x08\x20\
    \x03(\rR\x10staticPropIdList\x123\n\x0earea_step_info\x18\t\x20\x01(\x0b\
    2\r.AreaStepInfoR\x0careaStepInfo\x12\x1a\n\x08progress\x18\n\x20\x01(\r\
    R\x08progress\x123\n\x0cdynamic_info\x18\x0c\x20\x03(\x0b2\x10.AreaDynam\
    icInfoR\x0bdynamicInfo\x12\x17\n\x07area_id\x18\r\x20\x01(\rR\x06areaIdb\
    \x06proto3\
";
