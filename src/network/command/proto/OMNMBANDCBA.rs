...
impl ::protobuf::Message for OMNMBANDCBA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JFIGNBBLCIM != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.JFIGNBBLCIM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JFIGNBBLCIM != 0 {
            os.write_uint32(13, self.JFIGNBBLCIM)?;
        }
        if self.LIAGGDDILGO != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    stDataR\x08costData\x12\x20\n\x0bJFIGNBBLCIM\x18\r\x20\x01(\rR\x0bJFIGNB\
    BLCIM\x12\x20\n\x0bLIAGGDDILGO\x18\x0e\x20\x01(\x05R\x0bLIAGGDDILGO\x1a>\
