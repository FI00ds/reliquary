...
impl ::protobuf::Message for DMHADFNOIGP {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.EIIMAEHCGBC != false {
            os.write_bool(3, self.EIIMAEHCGBC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .\n\x0bJOJJKJFHMBI\x18\x02\x20\x03(\x0b2\x0c.MOJFFDOILBNR\x0bJOJJKJFHMBI\
    \x12\x20\n\x0bEIIMAEHCGBC\x18\x03\x20\x01(\x08R\x0bEIIMAEHCGBCb\x06proto\
    3\
";
