...
impl ::protobuf::Message for SpaceZooCatUpdateNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.FHHCNGAGFCJ != false {
            os.write_bool(2, self.FHHCNGAGFCJ)?;
        }
        if self.HCGHLFAKIKI != false {
            os.write_bool(6, self.HCGHLFAKIKI)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17SpaceZooCatUpdateNotify\x12\x20\n\x0bFHHCNGAGFCJ\x18\x02\x20\x01(\
    \x08R\x0bFHHCNGAGFCJ\x12\x20\n\x0bHCGHLFAKIKI\x18\x06\x20\x01(\x08R\x0bH\
    CGHLFAKIKI\x12.\n\x0bHMAIHHCBFKP\x18\x0b\x20\x03(\x0b2\x0c.DBLILHCLPPLR\
    \x0bHMAIHHCBFKPb\x06proto3\
";
