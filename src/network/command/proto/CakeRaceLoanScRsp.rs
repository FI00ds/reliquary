...
impl ::protobuf::Message for CakeRaceLoanScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AKEABJGIKLI != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.AKEABJGIKLI);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AKEABJGIKLI != 0 {
            os.write_uint32(7, self.AKEABJGIKLI)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ScRsp\x12&\n\titem_list\x18\x04\x20\x01(\x0b2\t.ItemListR\x08itemList\
    \x12\x20\n\x0bAKEABJGIKLI\x18\x07\x20\x01(\rR\x0bAKEABJGIKLI\x12\x18\n\
