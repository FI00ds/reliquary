...
impl ::protobuf::Message for HeliobusUnlockSkillScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ENGEPMPCJPC != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.ENGEPMPCJPC);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ENGEPMPCJPC != 0 {
            os.write_uint32(12, self.ENGEPMPCJPC)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x19\n\x08skill_id\x18\x04\x20\x01(\rR\x07skillId\x12\x20\n\x0bENGEP\
    MPCJPC\x18\x0c\x20\x01(\rR\x0bENGEPMPCJPCb\x06proto3\
";
