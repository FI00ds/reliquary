...
impl ::protobuf::Message for RotateMapCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PCCCKLNCLHB != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.PCCCKLNCLHB);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.PCCCKLNCLHB != 0 {
            os.write_uint32(2, self.PCCCKLNCLHB)?;
        }
        if let Some(v) = self.COOOMDKGODF.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    proto\"\xa4\x01\n\x0eRotateMapCsReq\x12\x20\n\x0bPCCCKLNCLHB\x18\x02\x20\
    \x01(\rR\x0bPCCCKLNCLHB\x120\n\x0bCOOOMDKGODF\x18\x08\x20\x01(\x0b2\x0e.\
    RotateMapInfoR\x0bCOOOMDKGODF\x12\x19\n\x08group_id\x18\t\x20\x01(\rR\
    \x07groupId\x12#\n\x06motion\x18\x0e\x20\x01(\x0b2\x0b.MotionInfoR\x06mo\
    tionb\x06proto3\
";
