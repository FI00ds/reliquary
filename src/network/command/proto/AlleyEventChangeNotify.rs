...
impl ::protobuf::Message for AlleyEventChangeNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KHANHNFACLN != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.KHANHNFACLN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KHANHNFACLN != 0 {
            os.write_uint32(8, self.KHANHNFACLN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    yEventChangeNotify\x12.\n\x0bOOOACLEFDGM\x18\x03\x20\x01(\x0b2\x0c.CEKIF\
    BMPEFHR\x0bOOOACLEFDGM\x12\x20\n\x0bKHANHNFACLN\x18\x08\x20\x01(\rR\x0bK\
    HANHNFACLNb\x06proto3\
";
