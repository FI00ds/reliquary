...
impl ::protobuf::Message for ClientMail {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MailType_Normal) {
            my_size += ::protobuf::rt::int32_size(2, self.mail_type.value());
        }
        ...
        if self.template_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.template_id);
        }
        if self.id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.mail_type != ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MailType_Normal) {
            os.write_enum(2, ::protobuf::EnumOrUnknown::value(&self.mail_type))?;
        }
        if !self.title.is_empty() {
        ...
        if self.template_id != 0 {
            os.write_uint32(7, self.template_id)?;
        }
        if self.id != 0 {
    ...
    fn clear(&mut self) {
        self.is_read = false;
        self.mail_type = ::protobuf::EnumOrUnknown::new(super::MailType::MailType::MailType_Normal);
        self.title.clear();
        self.content.clear();
        self.sender.clear();
        self.template_id = 0;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\n\nClientMail\x12\x17\n\x07is_read\x18\x01\x20\x01(\x08R\x06isRead\
    \x12&\n\tmail_type\x18\x02\x20\x01(\x0e2\t.MailTypeR\x08mailType\x12\x14\
    \n\x05title\x18\x03\x20\x01(\tR\x05title\x12\x18\n\x07content\x18\x04\
    \x20\x01(\tR\x07content\x12\x16\n\x06sender\x18\x06\x20\x01(\tR\x06sende\
    r\x12\x1f\n\x0btemplate_id\x18\x07\x20\x01(\rR\ntemplateId\x12\x0e\n\x02\
    id\x18\x08\x20\x01(\rR\x02id\x12\x1b\n\tpara_list\x18\n\x20\x03(\tR\x08p\
    araList\x12)\n\nattachment\x18\x0c\x20\x01(\x0b2\t.ItemListR\nattachment\
    \x12\x1f\n\x0bexpire_time\x18\x0e\x20\x01(\x03R\nexpireTime\x12\x12\n\
    \x04time\x18\x0f\x20\x01(\x03R\x04timeb\x06proto3\
";
