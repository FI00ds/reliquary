...
impl ::protobuf::Message for GetBasicInfoScRsp {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_gender_set != false {
            os.write_bool(5, self.is_gender_set)?;
        }
        if self.gameplay_birthday != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x11GetBasicInfoScRsp\x12%\n\x0eexchange_times\x18\x02\x20\x01(\rR\rexch\
    angeTimes\x12\x16\n\x06gender\x18\x03\x20\x01(\rR\x06gender\x12*\n\x11ne\
    xt_recover_time\x18\x04\x20\x01(\x03R\x0fnextRecoverTime\x12\"\n\ris_gen\
    der_set\x18\x05\x20\x01(\x08R\x0bisGenderSet\x12+\n\x11gameplay_birthday\
    \x18\x06\x20\x01(\rR\x10gameplayBirthday\x12;\n\x1aweek_cocoon_finished_\
    count\x18\x07\x20\x01(\rR\x17weekCocoonFinishedCount\x12B\n\x13player_se\
    tting_info\x18\x08\x20\x01(\x0b2\x12.PlayerSettingInfoR\x11playerSetting\
    Info\x123\n\x16last_set_nickname_time\x18\x0b\x20\x01(\x03R\x13lastSetNi\
    cknameTime\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07retcode\x12\x17\n\
    \x07cur_day\x18\x0f\x20\x01(\rR\x06curDayb\x06proto3\
";
