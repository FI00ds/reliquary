...
impl ::protobuf::Message for PlayerLoginScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.DKEPKHPOLHC.is_empty() {
            my_size += ::protobuf::rt::string_size(5, &self.DKEPKHPOLHC);
        }
        if !self.GIOAPOKHAOF.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.GIOAPOKHAOF);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KCDAHNNCKPP != false {
            os.write_bool(2, self.KCDAHNNCKPP)?;
        }
        if self.KDNPPNHLNOA != false {
            os.write_bool(3, self.KDNPPNHLNOA)?;
        }
        if !self.DKEPKHPOLHC.is_empty() {
            os.write_string(5, &self.DKEPKHPOLHC)?;
        }
        if !self.GIOAPOKHAOF.is_empty() {
            os.write_string(6, &self.GIOAPOKHAOF)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Timezone\x12\x20\n\x0bKCDAHNNCKPP\x18\x02\x20\x01(\x08R\x0bKCDAHNNCKPP\
    \x12\x20\n\x0bKDNPPNHLNOA\x18\x03\x20\x01(\x08R\x0bKDNPPNHLNOA\x12\x20\n\
    \x0bDKEPKHPOLHC\x18\x05\x20\x01(\tR\x0bDKEPKHPOLHC\x12\x20\n\x0bGIOAPOKH\
    AOF\x18\x06\x20\x01(\tR\x0bGIOAPOKHAOF\x12\x18\n\x07retcode\x18\x08\x20\
    \x01(\rR\x07retcode\x12!\n\x0clogin_random\x18\t\x20\x01(\x04R\x0bloginR\
    andom\x12/\n\nbasic_info\x18\x0b\x20\x01(\x0b2\x10.PlayerBasicInfoR\tbas\
    icInfo\x12.\n\x13server_timestamp_ms\x18\r\x20\x01(\x04R\x11serverTimest\
    ampMs\x12\x18\n\x07stamina\x18\x0f\x20\x01(\rR\x07staminab\x06proto3\
";
