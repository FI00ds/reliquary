...
impl ::protobuf::Message for SceneSummonUnitInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.attach_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.attach_entity_id);
        }
        if self.create_time_ms != 0 {
            my_size += ::protobuf::rt::uint64_size(5, self.create_time_ms);
        }
        if self.summon_unit_id != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.summon_unit_id);
        }
        for value in &self.trigger_name_list {
            my_size += ::protobuf::rt::string_size(10, &value);
        };
        if self.caster_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.caster_entity_id);
        }
        if self.life_time_ms != 0 {
            my_size += ::protobuf::rt::int32_size(13, self.life_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.attach_entity_id != 0 {
            os.write_uint32(1, self.attach_entity_id)?;
        }
        if self.create_time_ms != 0 {
            os.write_uint64(5, self.create_time_ms)?;
        }
        if self.summon_unit_id != 0 {
            os.write_uint32(7, self.summon_unit_id)?;
        }
        for v in &self.trigger_name_list {
            os.write_string(10, &v)?;
        };
        if self.caster_entity_id != 0 {
            os.write_uint32(12, self.caster_entity_id)?;
        }
        if self.life_time_ms != 0 {
            os.write_int32(13, self.life_time_ms)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x10attach_entity_id\x18\x01\x20\x01(\rR\x0eattachEntityId\x12$\n\x0ec\
    reate_time_ms\x18\x05\x20\x01(\x04R\x0ccreateTimeMs\x12$\n\x0esummon_uni\
    t_id\x18\x07\x20\x01(\rR\x0csummonUnitId\x12*\n\x11trigger_name_list\x18\
    \n\x20\x03(\tR\x0ftriggerNameList\x12(\n\x10caster_entity_id\x18\x0c\x20\
    \x01(\rR\x0ecasterEntityId\x12\x20\n\x0clife_time_ms\x18\r\x20\x01(\x05R\
