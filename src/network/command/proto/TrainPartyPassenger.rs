...
impl ::protobuf::Message for TrainPartyPassenger {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.GHPFANGEMAN);
        if self.record_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.JGDNJOFHCNC != false {
            os.write_bool(3, self.JGDNJOFHCNC)?;
        }
        os.write_repeated_packed_uint32(5, &self.GHPFANGEMAN)?;
        if self.record_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bJGDNJOFHCNC\x18\x03\x20\x01(\x08R\x0bJGDNJOFHCNC\x12\x20\n\x0b\
    GHPFANGEMAN\x18\x05\x20\x03(\rR\x0bGHPFANGEMAN\x12\x1b\n\trecord_id\x18\
    \x06\x20\x01(\rR\x08recordId\x12!\n\x0cpassenger_id\x18\x0f\x20\x01(\rR\
