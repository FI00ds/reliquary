...
impl ::protobuf::Message for OCDBIMIBNCD {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.POHBLAMKNJH);
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.LEIJJGDJECI);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(7, &self.POHBLAMKNJH)?;
        os.write_repeated_packed_uint32(12, &self.LEIJJGDJECI)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07\x20\x03(\rR\x0bPOHBLAMKNJH\x12\x20\n\x0bLEIJJGDJECI\x18\x0c\x20\x03\
