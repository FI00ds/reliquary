...
impl ::protobuf::Message for UpdateMarkChestScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.trigger_param_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.trigger_param_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.trigger_param_id != 0 {
            os.write_uint32(4, self.trigger_param_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x14UpdateMarkChestScRsp\x12\x17\n\x07func_id\x18\x01\x20\x01(\rR\
    \x06funcId\x12(\n\x10trigger_param_id\x18\x04\x20\x01(\rR\x0etriggerPara\
    mId\x12C\n\x14mark_chest_func_info\x18\x06\x20\x03(\x0b2\x12.MarkChestFu\
    ncInfoR\x11markChestFuncInfo\x12\x18\n\x07retcode\x18\x0e\x20\x01(\rR\
