...
impl ::protobuf::Message for DailyActivityInfo {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_has_taken != false {
            os.write_bool(7, self.is_has_taken)?;
        }
        if self.daily_active_point != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05level\x18\x01\x20\x01(\rR\x05level\x12\x1f\n\x0bworld_level\x18\x05\
    \x20\x01(\rR\nworldLevel\x12\x20\n\x0cis_has_taken\x18\x07\x20\x01(\x08R\
    \nisHasTaken\x12,\n\x12daily_active_point\x18\x08\x20\x01(\rR\x10dailyAc\
    tivePointb\x06proto3\
";
