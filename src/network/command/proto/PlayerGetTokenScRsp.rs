...
impl ::protobuf::Message for PlayerGetTokenScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.authkey.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.authkey);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.authkey.is_empty() {
            os.write_string(14, &self.authkey)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tKeySeed\x12\x1b\n\tstop_desc\x18\x02\x20\x01(\tR\x08stopDesc\x12\x10\n\
    ...
    retcode\x12\x18\n\x07authkey\x18\x0e\x20\x01(\tR\x07authkeyb\x06proto3\
";
