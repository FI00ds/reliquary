...
impl ::protobuf::Message for SpaceZooDeleteCatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(2, &self.ANHNMANNAEP);
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(2, &self.ANHNMANNAEP)?;
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bANHNMANNAEP\x18\x02\x20\x03(\rR\x0bANHNMANNAEP\x12\x18\n\x07re\
