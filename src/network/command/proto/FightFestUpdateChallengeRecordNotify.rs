...
impl ::protobuf::Message for FightFestUpdateChallengeRecordNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HMBBBNKAILD != ::protobuf::EnumOrUnknown::new(super::BGLIMCBGLAJ::BGLIMCBGLAJ::BGLIMCBGLAJ_PICLIGEAJFN) {
            my_size += ::protobuf::rt::int32_size(6, self.HMBBBNKAILD.value());
        }
        if self.turn_left != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HMBBBNKAILD != ::protobuf::EnumOrUnknown::new(super::BGLIMCBGLAJ::BGLIMCBGLAJ::BGLIMCBGLAJ_PICLIGEAJFN) {
            os.write_enum(6, ::protobuf::EnumOrUnknown::value(&self.HMBBBNKAILD))?;
        }
        if self.turn_left != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\rR\x0bchallengeId\x12\x20\n\x04rank\x18\x04\x20\x01(\
    \x0e2\x0c.BGLIMCBGLAJR\x04rank\x12.\n\x0bHMBBBNKAILD\x18\x06\x20\x01(\
    \x0e2\x0c.BGLIMCBGLAJR\x0bHMBBBNKAILD\x12\x1b\n\tturn_left\x18\x0c\x20\
    \x01(\rR\x08turnLeft\x12\x20\n\x0bDJFGDMIDEHJ\x18\r\x20\x01(\rR\x0bDJFGD\
    MIDEHJb\x06proto3\
";
