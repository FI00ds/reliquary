...
impl ::protobuf::Message for AiPamResponseFeedbackScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.BDPIMPJOJBK != ::protobuf::EnumOrUnknown::new(super::FKNKNLGMACL::FKNKNLGMACL::FKNKNLGMACL_NLCDGIPGFDJ) {
            my_size += ::protobuf::rt::int32_size(15, self.BDPIMPJOJBK.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.IAJAOMAKAHA != false {
            os.write_bool(2, self.IAJAOMAKAHA)?;
        }
        if self.NMMJBGFDNAI != false {
            os.write_bool(6, self.NMMJBGFDNAI)?;
        }
        if self.retcode != 0 {
            os.write_uint32(12, self.retcode)?;
        }
        if self.BDPIMPJOJBK != ::protobuf::EnumOrUnknown::new(super::FKNKNLGMACL::FKNKNLGMACL::FKNKNLGMACL_NLCDGIPGFDJ) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.BDPIMPJOJBK))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x1aAiPamResponseFeedbackScRsp\x12\x20\n\x0bIAJAOMAKAHA\x18\x02\
    \x20\x01(\x08R\x0bIAJAOMAKAHA\x12\x20\n\x0bNMMJBGFDNAI\x18\x06\x20\x01(\
    \x08R\x0bNMMJBGFDNAI\x12\x18\n\x07retcode\x18\x0c\x20\x01(\rR\x07retcode\
    \x12.\n\x0bBDPIMPJOJBK\x18\x0f\x20\x01(\x0e2\x0c.FKNKNLGMACLR\x0bBDPIMPJ\
    OJBKb\x06proto3\
";
