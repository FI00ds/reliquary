...
impl ::protobuf::Message for AvatarPathChangedNotify {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.cur_multi_path_avatar_type != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarType_None) {
            my_size += ::protobuf::rt::int32_size(8, self.cur_multi_path_avatar_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.cur_multi_path_avatar_type != ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarType_None) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.cur_multi_path_avatar_type))?;
        }
        if self.base_avatar_id != 0 {
    ...
    fn clear(&mut self) {
        self.cur_multi_path_avatar_type = ::protobuf::EnumOrUnknown::new(super::MultiPathAvatarType::MultiPathAvatarType::MultiPathAvatarType_None);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pe\x18\x08\x20\x01(\x0e2\x14.MultiPathAvatarTypeR\x16curMultiPathAvatarT\
    ype\x12$\n\x0ebase_avatar_id\x18\n\x20\x01(\rR\x0cbaseAvatarIdb\x06proto\
    3\
";
