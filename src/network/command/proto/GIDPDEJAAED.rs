...
//! Generated file from `GIDPDEJAAED.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:GIDPDEJAAED)
...
impl<'a> ::std::default::Default for &'a GIDPDEJAAED {
    fn default() -> &'a GIDPDEJAAED {
        <GIDPDEJAAED as ::protobuf::Message>::default_instance()
    }
}

impl GIDPDEJAAED {
    pub fn new() -> GIDPDEJAAED {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::CLHIJOAKJCE::CLHIJOAKJCE>(
            "KEMIMHMOHIE",
            |m: &GIDPDEJAAED| { &m.KEMIMHMOHIE },
            |m: &mut GIDPDEJAAED| { &mut m.KEMIMHMOHIE },
        ));
...
impl ::protobuf::Message for GIDPDEJAAED {
    const NAME: &'static str = "GIDPDEJAAED";
...
impl ::protobuf::MessageFull for GIDPDEJAAED {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("GIDPDEJAAED").unwrap()).clone()
    }
}

impl ::std::fmt::Display for GIDPDEJAAED {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GIDPDEJAAED {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(GIDPDEJAAED::generated_message_descriptor_data());
