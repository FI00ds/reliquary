...
impl ::protobuf::Message for GetPlayerBoardDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.current_personal_card_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.current_personal_card_id);
        }
        if self.current_head_icon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.current_head_icon_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.unlocked_personal_card_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.assist_avatar_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.current_personal_card_id != 0 {
            os.write_uint32(1, self.current_personal_card_id)?;
        }
        if self.current_head_icon_id != 0 {
            os.write_uint32(4, self.current_head_icon_id)?;
        }
        os.write_repeated_packed_uint32(5, &self.unlocked_personal_card_list)?;
        if !self.signature.is_empty() {
        ...
        os.write_repeated_packed_uint32(10, &self.assist_avatar_id_list)?;
        if let Some(v) = self.display_avatar_vec.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    erBoardDataScRsp\x127\n\x18current_personal_card_id\x18\x01\x20\x01(\rR\
    \x15currentPersonalCardId\x12/\n\x14current_head_icon_id\x18\x04\x20\x01\
    (\rR\x11currentHeadIconId\x12=\n\x1bunlocked_personal_card_list\x18\x05\
    \x20\x03(\rR\x18unlockedPersonalCardList\x12\x1c\n\tsignature\x18\x06\
    \x20\x01(\tR\tsignature\x126\n\x0fhead_frame_info\x18\x07\x20\x01(\x0b2\
    \x0e.HeadFrameInfoR\rheadFrameInfo\x12D\n\x17unlocked_head_icon_list\x18\
    \t\x20\x03(\x0b2\r.HeadIconDataR\x14unlockedHeadIconList\x121\n\x15assis\
    t_avatar_id_list\x18\n\x20\x03(\rR\x12assistAvatarIdList\x12?\n\x12displ\
    ay_avatar_vec\x18\r\x20\x01(\x0b2\x11.DisplayAvatarVecR\x10displayAvatar\
