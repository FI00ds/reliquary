...
impl ::protobuf::Message for BMOIPALHBJN {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.AAIODNCLAIP != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.AAIODNCLAIP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.AAIODNCLAIP != 0 {
            os.write_uint32(7, self.AAIODNCLAIP)?;
        }
        if self.JOMDKGINNEK != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    BJN\x12.\n\x0bOGDKJPDFFAI\x18\x01\x20\x03(\x0b2\x0c.NJHFBDDHCENR\x0bOGDK\
    JPDFFAI\x12\x20\n\x0bAAIODNCLAIP\x18\x07\x20\x01(\rR\x0bAAIODNCLAIP\x12\
    \x20\n\x0bJOMDKGINNEK\x18\x08\x20\x01(\rR\x0bJOMDKGINNEK\x12\x17\n\x07sh\
    op_id\x18\x0c\x20\x01(\rR\x06shopIdb\x06proto3\
";
