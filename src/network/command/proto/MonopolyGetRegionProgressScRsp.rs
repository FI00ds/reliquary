...
impl ::protobuf::Message for MonopolyGetRegionProgressScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.HEIHPAPJHID != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.HEIHPAPJHID);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.retcode);
        }
        if self.CNGMMDKCBND != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.CNGMMDKCBND);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.HEIHPAPJHID != 0 {
            os.write_uint32(3, self.HEIHPAPJHID)?;
        }
        if self.retcode != 0 {
            os.write_uint32(4, self.retcode)?;
        }
        if self.CNGMMDKCBND != 0 {
            os.write_uint32(10, self.CNGMMDKCBND)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sScRsp\x12\x20\n\x0bHEIHPAPJHID\x18\x03\x20\x01(\rR\x0bHEIHPAPJHID\x12\
    \x18\n\x07retcode\x18\x04\x20\x01(\rR\x07retcode\x12\x20\n\x0bCNGMMDKCBN\
    D\x18\n\x20\x01(\rR\x0bCNGMMDKCBNDb\x06proto3\
";
