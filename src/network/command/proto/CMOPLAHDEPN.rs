...
//! Generated file from `CMOPLAHDEPN.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:CMOPLAHDEPN)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CMOPLAHDEPN {
    // message fields
...
impl<'a> ::std::default::Default for &'a CMOPLAHDEPN {
    fn default() -> &'a CMOPLAHDEPN {
        <CMOPLAHDEPN as ::protobuf::Message>::default_instance()
    }
}

impl CMOPLAHDEPN {
    pub fn new() -> CMOPLAHDEPN {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            ...
            |m: &mut CMOPLAHDEPN| { &mut m.tierce_avatar_id_list },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "peak_avatar_id_list",
...
impl ::protobuf::Message for CMOPLAHDEPN {
    const NAME: &'static str = "CMOPLAHDEPN";
...
impl ::protobuf::MessageFull for CMOPLAHDEPN {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CMOPLAHDEPN").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CMOPLAHDEPN {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CMOPLAHDEPN {
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(CMOPLAHDEPN::generated_message_descriptor_data());
