...
impl ::protobuf::Message for ChangeStoryLineFinishScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ONBMNAMBIGE != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.ONBMNAMBIGE);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ONBMNAMBIGE != 0 {
            os.write_uint32(3, self.ONBMNAMBIGE)?;
        }
        if self.HBFDGEPBLNP != false {
            os.write_bool(10, self.HBFDGEPBLNP)?;
        }
        if self.cur_story_line_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x03\x20\x01(\rR\x0bONBMNAMBIGE\x12\x20\n\x0bHBFDGEPBLNP\x18\n\x20\
    \x01(\x08R\x0bHBFDGEPBLNP\x12)\n\x11cur_story_line_id\x18\x0e\x20\x01(\r\
