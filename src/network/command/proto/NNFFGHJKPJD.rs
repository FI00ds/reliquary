...
impl ::protobuf::Message for NNFFGHJKPJD {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JOMDKGINNEK != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.JOMDKGINNEK);
        }
        if self.shop_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JOMDKGINNEK != 0 {
            os.write_uint32(5, self.JOMDKGINNEK)?;
        }
        if self.shop_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    PJD\x12.\n\x0bOGDKJPDFFAI\x18\x02\x20\x03(\x0b2\x0c.NJHFBDDHCENR\x0bOGDK\
    JPDFFAI\x12\x20\n\x0bJOMDKGINNEK\x18\x05\x20\x01(\rR\x0bJOMDKGINNEK\x12\
    \x17\n\x07shop_id\x18\n\x20\x01(\rR\x06shopId\x12\x20\n\x0bAAIODNCLAIP\
    \x18\x0e\x20\x01(\rR\x0bAAIODNCLAIPb\x06proto3\
";
