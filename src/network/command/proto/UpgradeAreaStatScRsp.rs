...
impl ::protobuf::Message for UpgradeAreaStatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GNBKDCHLDGL != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::StatType_None) {
            my_size += ::protobuf::rt::int32_size(12, self.GNBKDCHLDGL.value());
        }
        if self.area_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GNBKDCHLDGL != ::protobuf::EnumOrUnknown::new(super::StatType::StatType::StatType_None) {
            os.write_enum(12, ::protobuf::EnumOrUnknown::value(&self.GNBKDCHLDGL))?;
        }
        if self.area_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0c\x20\x01(\x0e2\t.StatTypeR\x0bGNBKDCHLDGL\x12\x17\n\x07area_id\x18\
    \x0e\x20\x01(\rR\x06areaIdb\x06proto3\
";
