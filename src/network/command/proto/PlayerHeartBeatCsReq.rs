...
impl ::protobuf::Message for PlayerHeartBeatCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EOHFCODKKMD != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.EOHFCODKKMD);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.EOHFCODKKMD != 0 {
            os.write_uint32(5, self.EOHFCODKKMD)?;
        }
        if self.client_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14PlayerHeartBeatCsReq\x12\x20\n\x0bEOHFCODKKMD\x18\x05\x20\x01(\rR\
    \x0bEOHFCODKKMD\x12$\n\x0eclient_time_ms\x18\x0c\x20\x01(\x04R\x0cclient\
    TimeMs\x12%\n\x07sc_data\x18\x0e\x20\x01(\x0b2\x0c.LFKKOMBKJIPR\x06scDat\
    ab\x06proto3\
";
