...
impl ::protobuf::Message for Quest {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(6, &self.EBBFIOIOPAD);
        if self.progress != 0 {
        ...
        if self.status != ::protobuf::EnumOrUnknown::new(super::QuestStatus::QuestStatus::QuestStatus_QuestNone) {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(6, &self.EBBFIOIOPAD)?;
        if self.progress != 0 {
    ...
    fn clear(&mut self) {
        ...
        self.progress = 0;
        self.id = 0;
        self.status = ::protobuf::EnumOrUnknown::new(super::QuestStatus::QuestStatus::QuestStatus_QuestNone);
        self.finish_time = 0;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0bEBBFIOIOPAD\x18\x06\x20\x03(\rR\x0bEBBFIOIOPAD\x12\x1a\n\x08progre\
    ss\x18\x08\x20\x01(\rR\x08progress\x12\x0e\n\x02id\x18\x0b\x20\x01(\rR\
    \x02id\x12$\n\x06status\x18\x0c\x20\x01(\x0e2\x0c.QuestStatusR\x06status\
