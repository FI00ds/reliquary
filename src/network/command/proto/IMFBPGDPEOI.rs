...
impl ::protobuf::Message for IMFBPGDPEOI {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.JENKDACFCDO != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.JENKDACFCDO);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.retcode);
        }
        if self.ECGDECADBDO != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.ECGDECADBDO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.JENKDACFCDO != 0 {
            os.write_uint32(10, self.JENKDACFCDO)?;
        }
        if self.retcode != 0 {
            os.write_uint32(13, self.retcode)?;
        }
        if self.ECGDECADBDO != 0 {
            os.write_uint32(14, self.ECGDECADBDO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11IMFBPGDPEOI.proto\"\xa8\x01\n\x0bIMFBPGDPEOI\x12\x20\n\x0bJALHKMEO\
    OPN\x18\x07\x20\x01(\rR\x0bJALHKMEOOPN\x12\x19\n\x08group_id\x18\t\x20\
    \x01(\rR\x07groupId\x12\x20\n\x0bJENKDACFCDO\x18\n\x20\x01(\rR\x0bJENKDA\
    CFCDO\x12\x18\n\x07retcode\x18\r\x20\x01(\rR\x07retcode\x12\x20\n\x0bECG\
    DECADBDO\x18\x0e\x20\x01(\rR\x0bECGDECADBDOb\x06proto3\
";
