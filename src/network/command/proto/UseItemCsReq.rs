...
impl ::protobuf::Message for UseItemCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.KANPPCMBJHG != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AvatarType_None) {
            my_size += ::protobuf::rt::int32_size(11, self.KANPPCMBJHG.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.DGEKFCHEAPO != false {
            os.write_bool(8, self.DGEKFCHEAPO)?;
        }
        if self.KANPPCMBJHG != ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AvatarType_None) {
            os.write_enum(11, ::protobuf::EnumOrUnknown::value(&self.KANPPCMBJHG))?;
        }
        if self.optional_reward_id != 0 {
    ...
    fn clear(&mut self) {
        ...
        self.KANPPCMBJHG = ::protobuf::EnumOrUnknown::new(super::AvatarType::AvatarType::AvatarType_None);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1e\n\x0buse_item_id\x18\x06\x20\x01(\rR\tuseItemId\x12\x20\n\x0bDGEKFC\
    HEAPO\x18\x08\x20\x01(\x08R\x0bDGEKFCHEAPO\x12-\n\x0bKANPPCMBJHG\x18\x0b\
    \x20\x01(\x0e2\x0b.AvatarTypeR\x0bKANPPCMBJHG\x12,\n\x12optional_reward_\
    id\x18\x0e\x20\x01(\rR\x10optionalRewardId\x12$\n\x0euse_item_count\x18\
