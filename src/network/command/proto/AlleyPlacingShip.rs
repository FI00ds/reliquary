...
impl ::protobuf::Message for AlleyPlacingShip {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ship_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.ship_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.ship_id != 0 {
            os.write_uint32(9, self.ship_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ngShip\x12+\n\ngoods_list\x18\x01\x20\x03(\x0b2\x0c.CBBPDLPAIPLR\tgoodsL\
    ist\x12\x17\n\x07ship_id\x18\t\x20\x01(\rR\x06shipIdb\x06proto3\
";
