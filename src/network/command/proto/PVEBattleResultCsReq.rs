...
pub struct PVEBattleResultCsReq {
    ...
    pub LGOJDHLMGEN: u32,
    // @@protoc_insertion_point(field:PVEBattleResultCsReq.LJKMPIMKOMO)
    pub LJKMPIMKOMO: u32,
...
impl PVEBattleResultCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LJKMPIMKOMO",
            |m: &PVEBattleResultCsReq| { &m.LJKMPIMKOMO },
            |m: &mut PVEBattleResultCsReq| { &mut m.LJKMPIMKOMO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DKIDHMAOMJB",
...
impl ::protobuf::Message for PVEBattleResultCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.LGOJDHLMGEN != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.LGOJDHLMGEN);
        }
        if self.LJKMPIMKOMO != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.LJKMPIMKOMO);
        }
        ...
        if self.NIBMFCFBHEP != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.NIBMFCFBHEP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.LGJMMJEFGNK != false {
            os.write_bool(1, self.LGJMMJEFGNK)?;
        }
        for v in &self.op_list {
            ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
        };
        if self.LGOJDHLMGEN != 0 {
            os.write_uint32(3, self.LGOJDHLMGEN)?;
        }
        if self.LJKMPIMKOMO != 0 {
            os.write_uint32(4, self.LJKMPIMKOMO)?;
        }
        if self.DKIDHMAOMJB != false {
            os.write_bool(5, self.DKIDHMAOMJB)?;
        }
        for (k, v) in &self.LJJEOOJCEOG {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::string_size(1, &k);
        ...
        if self.NIBMFCFBHEP != 0 {
            os.write_uint32(12, self.NIBMFCFBHEP)?;
        }
        if self.end_status != ::protobuf::EnumOrUnknown::new(super::BattleEndStatus::BattleEndStatus::BATTLE_END_NONE) {
        ...
        if self.NNGDLOHALCN != false {
            os.write_bool(15, self.NNGDLOHALCN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tleOp.proto\x1a\x16BattleStatistics.proto\"\x93\x05\n\x14PVEBattleResult\
    CsReq\x12\x20\n\x0bLGJMMJEFGNK\x18\x01\x20\x01(\x08R\x0bLGJMMJEFGNK\x12\
    \"\n\x07op_list\x18\x02\x20\x03(\x0b2\t.BattleOpR\x06opList\x12\x20\n\
    \x0bLGOJDHLMGEN\x18\x03\x20\x01(\rR\x0bLGOJDHLMGEN\x12\x20\n\x0bLJKMPIMK\
    OMO\x18\x04\x20\x01(\rR\x0bLJKMPIMKOMO\x12\x20\n\x0bDKIDHMAOMJB\x18\x05\
    \x20\x01(\x08R\x0bDKIDHMAOMJB\x12H\n\x0bLJJEOOJCEOG\x18\x06\x20\x03(\x0b\
    2&.PVEBattleResultCsReq.LJJEOOJCEOGEntryR\x0bLJJEOOJCEOG\x12\x1b\n\tbatt\
    le_id\x18\x07\x20\x01(\rR\x08battleId\x12\x1b\n\tcost_time\x18\x08\x20\
    \x01(\rR\x08costTime\x12(\n\x10debug_extra_info\x18\t\x20\x01(\tR\x0edeb\
    ugExtraInfo\x12#\n\x03stt\x18\n\x20\x01(\x0b2\x11.BattleStatisticsR\x03s\
    tt\x12,\n\x12turn_snapshot_hash\x18\x0b\x20\x01(\x0cR\x10turnSnapshotHas\
    h\x12\x20\n\x0bNIBMFCFBHEP\x18\x0c\x20\x01(\rR\x0bNIBMFCFBHEP\x12/\n\nen\
    d_status\x18\r\x20\x01(\x0e2\x10.BattleEndStatusR\tendStatus\x12\x19\n\
    \x08stage_id\x18\x0e\x20\x01(\rR\x07stageId\x12\x20\n\x0bNNGDLOHALCN\x18\
    \x0f\x20\x01(\x08R\x0bNNGDLOHALCN\x1a>\n\x10LJJEOOJCEOGEntry\x12\x10\n\
