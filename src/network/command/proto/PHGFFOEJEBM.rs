...
impl ::protobuf::Message for PHGFFOEJEBM {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.PEOODHOAJMP.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.PEOODHOAJMP);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.PEOODHOAJMP.is_empty() {
            os.write_string(2, &self.PEOODHOAJMP)?;
        }
        if !self.EGCPAOEAGLF.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\x20\x01(\tR\x0bPEOODHOAJMP\x12\x20\n\x0bEGCPAOEAGLF\x18\x07\x20\x01\
