...
impl ::protobuf::Message for DoGachaInRollShopScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.reward_display_type != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.reward_display_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.reward_display_type != 0 {
            os.write_uint32(8, self.reward_display_type)?;
        }
        if let Some(v) = self.reward.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    eward_display_type\x18\x08\x20\x01(\rR\x11rewardDisplayType\x12!\n\x06re\
    ward\x18\n\x20\x01(\x0b2\t.ItemListR\x06reward\x12\x20\n\x0bLDBCKJIPDHF\
    \x18\x0c\x20\x01(\rR\x0bLDBCKJIPDHFb\x06proto3\
";
