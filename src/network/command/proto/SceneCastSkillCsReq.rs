...
impl ::protobuf::Message for SceneCastSkillCsReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.maze_ability_str.is_empty() {
            my_size += ::protobuf::rt::string_size(8, &self.maze_ability_str);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.assist_monster_entity_id_list);
        if self.KCFABNFPOPN != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.KCFABNFPOPN);
        }
        ...
        if self.skill_index != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.skill_index);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.maze_ability_str.is_empty() {
            os.write_string(8, &self.maze_ability_str)?;
        }
        os.write_repeated_packed_uint32(9, &self.assist_monster_entity_id_list)?;
        if self.KCFABNFPOPN != 0 {
            os.write_uint32(10, self.KCFABNFPOPN)?;
        }
        for v in &self.dynamic_values {
            ::protobuf::rt::write_message_field_with_cached_size(11, v, os)?;
        };
        if self.skill_index != 0 {
            os.write_uint32(12, self.skill_index)?;
        }
        if self.attacked_by_entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ster_entity_info\x18\x05\x20\x03(\x0b2\x18.AssistMonsterEntityInfoR\x17a\
    ssistMonsterEntityInfo\x128\n\x19hit_target_entity_id_list\x18\x06\x20\
    \x03(\rR\x15hitTargetEntityIdList\x120\n\rtarget_motion\x18\x07\x20\x01(\
    \x0b2\x0b.MotionInfoR\x0ctargetMotion\x12(\n\x10maze_ability_str\x18\x08\
    \x20\x01(\tR\x0emazeAbilityStr\x12@\n\x1dassist_monster_entity_id_list\
    \x18\t\x20\x03(\rR\x19assistMonsterEntityIdList\x12\x20\n\x0bKCFABNFPOPN\
    \x18\n\x20\x01(\rR\x0bKCFABNFPOPN\x125\n\x0edynamic_values\x18\x0b\x20\
    \x03(\x0b2\x0e.DynamicValuesR\rdynamicValues\x12\x1f\n\x0bskill_index\
    \x18\x0c\x20\x01(\rR\nskillIndex\x121\n\x15attacked_by_entity_id\x18\x0e\
    \x20\x01(\rR\x12attackedByEntityId\x12$\n\x0ecast_entity_id\x18\x0f\x20\
