...
impl ::protobuf::Message for PlayerHeartBeatScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.server_time_ms != 0 {
            my_size += ::protobuf::rt::uint64_size(9, self.server_time_ms);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.server_time_ms != 0 {
            os.write_uint64(9, self.server_time_ms)?;
        }
        if self.client_time_ms != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x07retcode\x128\n\rdownload_data\x18\x08\x20\x01(\x0b2\x13.ClientDownlo\
    adDataR\x0cdownloadData\x12$\n\x0eserver_time_ms\x18\t\x20\x01(\x04R\x0c\
    serverTimeMs\x12$\n\x0eclient_time_ms\x18\n\x20\x01(\x04R\x0cclientTimeM\
    sb\x06proto3\
";
