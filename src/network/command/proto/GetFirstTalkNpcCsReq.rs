...
pub struct GetFirstTalkNpcCsReq {
    // message fields
    // @@protoc_insertion_point(field:GetFirstTalkNpcCsReq.FLJBOHAFLOK)
    pub FLJBOHAFLOK: ::std::vec::Vec<u32>,
    // special fields
...
impl GetFirstTalkNpcCsReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "FLJBOHAFLOK",
            |m: &GetFirstTalkNpcCsReq| { &m.FLJBOHAFLOK },
            |m: &mut GetFirstTalkNpcCsReq| { &mut m.FLJBOHAFLOK },
        ));
...
impl ::protobuf::Message for GetFirstTalkNpcCsReq {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                106 => {
                    is.read_repeated_packed_uint32_into(&mut self.FLJBOHAFLOK)?;
                },
                104 => {
                    self.FLJBOHAFLOK.push(is.read_uint32()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(13, &self.FLJBOHAFLOK);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(13, &self.FLJBOHAFLOK)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0bFLJBOHAFLOK\x18\r\x20\x03(\rR\x0bFLJBOHAFLOKb\x06proto3\
";
