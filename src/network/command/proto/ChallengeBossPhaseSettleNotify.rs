...
impl ::protobuf::Message for ChallengeBossPhaseSettleNotify {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_second_half != false {
            os.write_bool(6, self.is_second_half)?;
        }
        if self.AGAEPDNHPJC != false {
            os.write_bool(7, self.AGAEPDNHPJC)?;
        }
        if self.page_type != 0 {
            os.write_uint32(8, self.page_type)?;
        }
        if self.is_reward != false {
            os.write_bool(10, self.is_reward)?;
        }
        if self.star != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03\n\x1eChallengeBossPhaseSettleNotify\x12\x15\n\x06is_win\x18\x01\x20\
    \x01(\x08R\x05isWin\x12\x14\n\x05phase\x18\x02\x20\x01(\rR\x05phase\x12\
    \x1b\n\tscore_two\x18\x04\x20\x01(\rR\x08scoreTwo\x12'\n\x0fchallenge_sc\
    ore\x18\x05\x20\x01(\rR\x0echallengeScore\x12$\n\x0eis_second_half\x18\
    \x06\x20\x01(\x08R\x0cisSecondHalf\x12\x20\n\x0bAGAEPDNHPJC\x18\x07\x20\
    \x01(\x08R\x0bAGAEPDNHPJC\x12\x1b\n\tpage_type\x18\x08\x20\x01(\rR\x08pa\
    geType\x12\x1b\n\tis_reward\x18\n\x20\x01(\x08R\x08isReward\x12\x12\n\
    \x04star\x18\x0b\x20\x01(\rR\x04star\x12!\n\x0cchallenge_id\x18\r\x20\
    \x01(\rR\x0bchallengeId\x12;\n\x12battle_target_list\x18\x0f\x20\x03(\
    \x0b2\r.BattleTargetR\x10battleTargetListb\x06proto3\
";
