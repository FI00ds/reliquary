...
impl ::protobuf::Message for AnnounceData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.banner_text.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.banner_text);
        }
        if self.end_time != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.banner_text.is_empty() {
            os.write_string(9, &self.banner_text)?;
        }
        if self.end_time != 0 {
        ...
        if self.BBEBEKFGMAD != false {
            os.write_bool(13, self.BBEBEKFGMAD)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nd\x18\x01\x20\x01(\x08R\x0chasRecommand\x12%\n\x0eemergency_text\x18\
    \x02\x20\x01(\tR\remergencyText\x12\x1d\n\nbegin_time\x18\x04\x20\x01(\
    \x03R\tbeginTime\x12)\n\x10banner_frequency\x18\x07\x20\x01(\rR\x0fbanne\
    rFrequency\x12\x1f\n\x0bbanner_text\x18\t\x20\x01(\tR\nbannerText\x12\
    \x19\n\x08end_time\x18\n\x20\x01(\x03R\x07endTime\x12\x1b\n\tconfig_id\
    \x18\x0b\x20\x01(\rR\x08configId\x12\x20\n\x0bBBEBEKFGMAD\x18\r\x20\x01(\
    \x08R\x0bBBEBEKFGMADb\x06proto3\
";
