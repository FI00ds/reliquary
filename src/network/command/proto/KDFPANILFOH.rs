...
impl ::protobuf::Message for KDFPANILFOH {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.CHCOPKAKBNO != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.CHCOPKAKBNO);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.KEKFKKANACK != false {
            os.write_bool(4, self.KEKFKKANACK)?;
        }
        for v in &self.PAOEJKABFEP {
            ::protobuf::rt::write_message_field_with_cached_size(5, v, os)?;
        };
        if self.CHCOPKAKBNO != 0 {
            os.write_uint32(7, self.CHCOPKAKBNO)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xa1\x01\n\x0bKDFPANILFOH\x12#\n\x06motion\x18\x01\x20\x01(\x0b2\x0b.Mot\
    ionInfoR\x06motion\x12\x20\n\x0bKEKFKKANACK\x18\x04\x20\x01(\x08R\x0bKEK\
    FKKANACK\x12)\n\x0bPAOEJKABFEP\x18\x05\x20\x03(\x0b2\x07.VectorR\x0bPAOE\
    JKABFEP\x12\x20\n\x0bCHCOPKAKBNO\x18\x07\x20\x01(\rR\x0bCHCOPKAKBNOb\x06\
    proto3\
";
