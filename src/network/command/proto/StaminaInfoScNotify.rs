...
impl ::protobuf::Message for StaminaInfoScNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.EHJCPBJNEOO != 0 {
            my_size += ::protobuf::rt::int64_size(2, self.EHJCPBJNEOO);
        }
        if self.stamina != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.EHJCPBJNEOO != 0 {
            os.write_int64(2, self.EHJCPBJNEOO)?;
        }
        if self.stamina != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\n\x0bEHJCPBJNEOO\x18\x02\x20\x01(\x03R\x0bEHJCPBJNEOO\x12\x18\n\x07\
    stamina\x18\n\x20\x01(\rR\x07stamina\x12*\n\x11next_recover_time\x18\x0b\
    \x20\x01(\x03R\x0fnextRecoverTime\x12'\n\x0freserve_stamina\x18\r\x20\
    \x01(\rR\x0ereserveStaminab\x06proto3\
";
