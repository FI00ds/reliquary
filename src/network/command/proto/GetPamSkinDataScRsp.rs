...
impl ::protobuf::Message for GetPamSkinDataScRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.unlock_skin_list);
        if self.cur_skin != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.unlock_skin_list)?;
        if self.cur_skin != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lock_skin_list\x18\x01\x20\x03(\rR\x0eunlockSkinList\x12\x19\n\x08cur_sk\
    in\x18\x04\x20\x01(\rR\x07curSkin\x12\x18\n\x07retcode\x18\x06\x20\x01(\
