...
impl ::protobuf::Message for DiscardRelicScRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.IFEEJKMACHF != ::protobuf::EnumOrUnknown::new(super::RelicDiscardType::RelicDiscardType::RelicDiscardType_Single) {
            my_size += ::protobuf::rt::int32_size(11, self.IFEEJKMACHF.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.IFEEJKMACHF != ::protobuf::EnumOrUnknown::new(super::RelicDiscardType::RelicDiscardType::RelicDiscardType_Single) {
            os.write_enum(11, ::protobuf::EnumOrUnknown::value(&self.IFEEJKMACHF))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e\x12\x20\n\x0bDKPCAIGPHNO\x18\x04\x20\x01(\x08R\x0bDKPCAIGPHNO\x12\x1b\
    \n\trelic_ids\x18\x05\x20\x03(\rR\x08relicIds\x123\n\x0bIFEEJKMACHF\x18\
    \x0b\x20\x01(\x0e2\x11.RelicDiscardTypeR\x0bIFEEJKMACHFb\x06proto3\
";
